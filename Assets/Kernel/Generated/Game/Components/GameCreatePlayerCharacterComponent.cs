...
public partial class GameContext {
    ...
    public GameEntity createPlayerCharacterEntity { get { return GetGroup(GameMatcher.CreatePlayerCharacter).GetSingleEntity(); } }

    public bool isCreatePlayerCharacter {
        get { return createPlayerCharacterEntity != null; }
        set {
            var entity = createPlayerCharacterEntity;
            if (value != (entity != null)) {
                if (value) {
                    CreateEntity().isCreatePlayerCharacter = true;
                } else {
                    entity.Destroy();
                }
            }
