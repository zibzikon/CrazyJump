...
{
    public class HeightsDiapasonRowViewBehaviour : EntityBehaviour
    {
        ...
        private void UpdateView()
        {
            ...
            _heightIndicationTextMesh.text = rowWorldPosition.Round().ToString(CultureInfo.InvariantCulture);
